...
# * Create time   : 2018-05-25 00:21
# * Last modified : 2018-05-25 00:24
...
def bgl_data_loader(para):
	...
	# print('raw_data',raw_data[:20])
	# print('event_mapping_data',event_mapping_data[:20])
	print('raw_data.shape,event_mapping_data.shape',raw_data.shape,event_mapping_data.shape)
...
def bgl_preprocess_data(para, raw_data, event_mapping_data):
	...
	for j in range(inst_number):
		...
		for k in expanded_indexes_list[j]:
			...
			#print 'cur_j',j,'cur_evet_index',event_index
